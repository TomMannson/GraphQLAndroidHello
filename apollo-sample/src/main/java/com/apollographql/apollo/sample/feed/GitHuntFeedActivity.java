...
import com.apollographql.apollo.sample.FeatchAllAuthorsQuery;
import com.apollographql.apollo.sample.FeetchQuery;
...
public class GitHuntFeedActivity extends AppCompatActivity implements GitHuntNavigator {
  ...
  ApolloCall<FeatchAllAuthorsQuery.Data> githuntFeedCall;
  ...
  private ApolloCall.Callback<FeatchAllAuthorsQuery.Data> dataCallback
      = new ApolloCallback<>(new ApolloCall.Callback<FeatchAllAuthorsQuery.Data>() {
    @Override public void onResponse(@Nonnull Response<FeatchAllAuthorsQuery.Data> response) {
...
//  List<FeedEntry> feedResponseToEntriesWithRepositories(Response<FeetchQuery.Data> response) {
//    List<FeedEntry> feedEntriesWithRepos = new ArrayList<>();
//    final FeetchQuery.Data responseData = response.data();
...
//  }
  ...
  private void fetchFeed() {
    final FeatchAllAuthorsQuery feedQuery = FeatchAllAuthorsQuery.builder()
        .build();
//    final FeetchQuery feedQuery = FeetchQuery.builder()
//        .id("5acf613ab36a304d0097187f")
////        .limit(FEED_SIZE)
////        .type(FeedType.HOT)
//        .build();
