...
//    subscribeRepoCommentAdded();
  ...
  void setEntryData(FeetchQuery.Data data) {
//    content.setVisibility(View.VISIBLE);
//    progressBar.setVisibility(View.GONE);
//
//    final FeetchQuery.Entry entry = data.entry();
//    if (entry != null) {
...
//    commentsListViewAdapter.setItems(comments);
  ...
  private void fetchRepositoryDetails() {
    ApolloCall<FeetchQuery.Data> entryDetailQuery = application.apolloClient()
        .query(new FeetchQuery(Input.fromNullable(repoFullName)))
    ...
    disposables.add(Rx2Apollo.from(entryDetailQuery)
        ...
        .subscribeWith(new DisposableObserver<Response<FeetchQuery.Data>>() {
          @Override public void onNext(Response<FeetchQuery.Data> dataResponse) {
